            ...
            <div id="work_single_banner" class="bg-light w-100">
                <div class="container-fluid text-light d-flex justify-content-center align-items-center border-0 rounded-0 p-0 py-5">
                    <div class="banner-content col-lg-8 m-lg-auto text-center py-5 px-3">
                        <h1 class="banner-heading h2 pb-5 typo-space-line-center">클라우드 엔지니어링(Cloud Engineering)</h1>
            ...
            <section class="container py-5">
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">1. 클라우드 인프라 설계 및 구축</h2>
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">2. 클라우드 보안 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">3. 리소스 관리 및 최적화</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">4. 컨테이너화 및 오케스트레이션</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">5. 클라우드 네트워크 설정</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">6. 애플리케이션 배포 및 운영</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">7. 데이터베이스 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">8. 클라우드 서비스 통합 및 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">9. 모니터링 및 로깅</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">10. 클라우드 마이그레이션</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
