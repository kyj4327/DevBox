            ...
            <div id="work_single_banner" class="bg-light w-100">
                <div class="container-fluid text-light d-flex justify-content-center align-items-center border-0 rounded-0 p-0 py-5">
                    <div class="banner-content col-lg-8 m-lg-auto text-center py-5 px-3">
                        <h1 class="banner-heading h2 pb-5 typo-space-line-center">데브옵스(DevOps)</h1>
            ...
            <section class="container py-5">
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">1. CI/CD 파이프라인 구축 및 관리</h2>
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">2. 인프라 관리 및 자동화</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">3. 모니터링 및 로깅</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">5. 보안 및 규정 준수</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">6. 성능 최적화 및 문제 해결</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">7. 자동화 스크립트 및 도구 개발</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">8. 협업 및 커뮤니케이션</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">9. 배포 및 릴리즈 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
