            ...
            <div id="work_single_banner" class="bg-light w-100">
                <div class="container-fluid text-light d-flex justify-content-center align-items-center border-0 rounded-0 p-0 py-5">
                    <div class="banner-content col-lg-8 m-lg-auto text-center py-5 px-3">
                        <h1 class="banner-heading h2 pb-5 typo-space-line-center">모바일 개발자(Mobile)</h1>
            ...
            <section class="container py-5">
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">1. 모바일 애플리케이션 개발</h2>
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">2. UI/UX 디자인 구현</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">3. 애플리케이션 성능 최적화</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">4. API 연동 및 백엔드 통합</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">5. 데이터 관리 및 저장소 연동</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">6. 테스트 및 디버깅</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">7. 애플리케이션 배포 및 유지보수</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">8. 보안 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">9. 버전 관리 및 협업</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">10. 새로운 기술 및 트렌드 학습</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
