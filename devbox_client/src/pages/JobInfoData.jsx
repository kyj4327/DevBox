            ...
            <div id="work_single_banner" class="bg-light w-100">
                <div class="container-fluid text-light d-flex justify-content-center align-items-center border-0 rounded-0 p-0 py-5">
                    <div class="banner-content col-lg-8 m-lg-auto text-center py-5 px-3">
                        <h1 class="banner-heading h2 pb-5 typo-space-line-center">데이터 엔지니어링(Data Engineering)</h1>
            ...
            <section class="container py-5">
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">1. 데이터 파이프라인 설계 및 구축</h2>
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">2. 데이터베이스 및 데이터 웨어하우스 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">3. 데이터 파이프라인의 자동화 및 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">4. 데이터 품질 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">5. 데이터 보안 및 접근 제어</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">6. 빅데이터 처리 및 분석 지원</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">7. 클라우드 데이터 인프라 관리</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">8. 데이터 거버넌스 및 규정 준수</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
                ...
                <div class="row pt-5">
                    <div class="worksingle-content col-lg-8 m-auto text-left justify-content-center">
                        <h2 class="worksingle-heading h3 pb-3 light-300 typo-space-line">9. 협업 및 문서화</h2>
                        <p class="worksingle-footer py-3 text-muted light-300">
