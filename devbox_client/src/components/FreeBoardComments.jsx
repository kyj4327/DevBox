...
import { getCommentsByPostId, createComment, deleteComment, editComment } from '../services/api-service';
...
const FreeBoardComments = ({ postId }) => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            if (dropdownOpen.id !== null && !event.target.closest(".menu-icon-container")) {
